...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (void)linkTouched {
  [[BFFNavigator navigator] openURLAction:_URLAction];
}
...
- (void)setHighlighted:(BOOL)highlighted {
  ...
  if (highlighted) {
    if (!_screenView) {
      _screenView = [[BFFView alloc] initWithFrame:self.bounds];
      _screenView.style = BFFSTYLE(linkHighlighted);
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (void)setURLAction:(BFFURLAction*)URLAction {
  [URLAction retain];
  [_URLAction release];
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (void)setURL:(id)URL {
  self.URLAction = [[BFFURLAction actionWithURLPath:URL] applyAnimated:YES];
}
