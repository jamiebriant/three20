...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
@implementation BFFActivityLabel
...
- (id)initWithFrame:(CGRect)frame style:(BFFActivityLabelStyle)style text:(NSString*)text {
  if (self = [super initWithFrame:frame]) {
    ...
    _bezelView = [[BFFView alloc] init];
    if (_style == BFFActivityLabelStyleBlackBezel) {
      _bezelView.backgroundColor = [UIColor clearColor];
      _bezelView.style = BFFSTYLE(blackBezel);
      self.backgroundColor = [UIColor clearColor];
    } else if (_style == BFFActivityLabelStyleWhiteBezel) {
      _bezelView.backgroundColor = [UIColor clearColor];
      _bezelView.style = BFFSTYLE(whiteBezel);
      self.backgroundColor = [UIColor clearColor];
    } else if (_style == BFFActivityLabelStyleWhiteBox) {
      _bezelView.backgroundColor = [UIColor clearColor];
      self.backgroundColor = [UIColor whiteColor];
    } else if (_style == BFFActivityLabelStyleBlackBox) {
      _bezelView.backgroundColor = [UIColor clearColor];
      self.backgroundColor = [UIColor colorWithWhite:0 alpha:0.8];
    } else if (_style == BFFActivityLabelStyleBlackBanner) {
      _bezelView.backgroundColor = [UIColor clearColor];
      _bezelView.style = BFFSTYLE(blackBanner);
      self.backgroundColor = [UIColor clearColor];
    } else {
      _bezelView.backgroundColor = [UIColor clearColor];
      self.backgroundColor = [UIColor clearColor];
    ...
    if (_style == BFFActivityLabelStyleWhite) {
      _activityIndicator = [[UIActivityIndicatorView alloc] initWithActivityIndicatorStyle:
                                                            UIActivityIndicatorViewStyleWhite];
      _label.font = BFFSTYLEVAR(activityLabelFont);
      _label.textColor = [UIColor whiteColor];
    } else if (_style == BFFActivityLabelStyleGray
               || _style == BFFActivityLabelStyleWhiteBox
               || _style == BFFActivityLabelStyleWhiteBezel) {
      _activityIndicator = [[UIActivityIndicatorView alloc] initWithActivityIndicatorStyle:
                                                            UIActivityIndicatorViewStyleGray];
      _label.font = BFFSTYLEVAR(activityLabelFont);
      _label.textColor = BFFSTYLEVAR(tableActivityTextColor);
    } else if (_style == BFFActivityLabelStyleBlackBezel || _style == BFFActivityLabelStyleBlackBox) {
      _activityIndicator = [[UIActivityIndicatorView alloc] initWithActivityIndicatorStyle:
      ...
      _activityIndicator = [[UIActivityIndicatorView alloc] initWithActivityIndicatorStyle:
                                                            UIActivityIndicatorViewStyleWhite];
      _label.font = BFFSTYLEVAR(activityBannerFont);
      _label.textColor = [UIColor whiteColor];
      _label.shadowColor = [UIColor colorWithWhite:0 alpha:0.3];
      _label.shadowOffset = CGSizeMake(1, 1);
    }
...
- (id)initWithFrame:(CGRect)frame {
  if (self = [self initWithFrame:frame style:BFFActivityLabelStyleWhiteBox text:nil]) {
  }
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (void)dealloc {
  BFF_INVALIDATE_TIMER(_smoothTimer);
  BFF_RELEASE_SAFELY(_bezelView);
  BFF_RELEASE_SAFELY(_progressView);
  BFF_RELEASE_SAFELY(_activityIndicator);
...
- (void)layoutSubviews {
  ...
  if (_style == BFFActivityLabelStyleBlackBezel || _style == BFFActivityLabelStyleWhiteBezel) {
    margin = kMargin;
    padding = kPadding;
  ...
  CGFloat maxBevelWidth = BFFScreenBounds().size.width - margin*2;
  ...
  if (_progressView) {
    if (_style == BFFActivityLabelStyleBlackBanner) {
      y += kBannerPadding/2;
    }
