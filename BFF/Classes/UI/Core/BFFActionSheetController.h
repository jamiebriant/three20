...
@protocol BFFActionSheetControllerDelegate;

/**
 * A view controller that displays an action sheet.
 *
 * This class exists in order to allow action sheets to be displayed by BFFNavigator, and gain
 * all the benefits of persistence and URL dispatch.
 *
 * By default this controller is not persisted in the navigation history.
 */
@interface BFFActionSheetController : BFFPopupViewController <UIActionSheetDelegate> {
@protected
  id              _userInfo;
  NSMutableArray* _URLs;

  id<BFFActionSheetControllerDelegate> _delegate;
}

@property (nonatomic, readonly) UIActionSheet*  actionSheet;
@property (nonatomic, retain)   id              userInfo;

@property (nonatomic, assign)   id<BFFActionSheetControllerDelegate> delegate;
 ...
 *
 * @param title     The title of the action sheet.
 * @param delegate  A delegate that implements the BFFActionSheetControllerDelegate protocol.
 */
- (id)initWithTitle:(NSString*)title delegate:(id)delegate;

/**
 * Append a button with the given title and BFFNavigator URL.
 *
 * @param title The title of the new button.
 * @param URL   The BFFNavigator url.
...
/**
 * Create a cancel button with the given title and BFFNavigator URL.
 *
...
/**
 * Create a destructive button with the given title and BFFNavigator URL.
 *
