...
@protocol BFFTabDelegate;

@interface BFFTabBar : BFFView {
  NSString*       _tabStyle;
  ...
  id<BFFTabDelegate> _delegate;
}

@property (nonatomic, copy)     NSString*   tabStyle;

@property (nonatomic, assign)   BFFTabItem*  selectedTabItem;
@property (nonatomic, assign)   BFFTab*      selectedTabView;
@property (nonatomic)           NSInteger   selectedTabIndex;

@property (nonatomic, retain)   NSArray*    tabItems;
@property (nonatomic, readonly) NSArray*    tabViews;

@property (nonatomic, assign)   id<BFFTabDelegate> delegate;
