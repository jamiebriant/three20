...
@protocol BFFPostControllerDelegate;
@class BFFActivityLabel;
@class BFFView;

@interface BFFPostController : BFFPopupViewController <UITextViewDelegate> {
@protected
  id                _result;
  ...
  id<BFFPostControllerDelegate> _delegate;
}
...
@property (nonatomic, assign)   id<BFFPostControllerDelegate> delegate;
