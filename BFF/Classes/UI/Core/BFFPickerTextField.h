...
@class BFFPickerViewCell;

@interface BFFPickerTextField : BFFSearchTextField {
  NSMutableArray*   _cellViews;
  BFFPickerViewCell* _selectedCell;
  int               _lineCount;
...
@property (nonatomic, assign)   BFFPickerViewCell* selectedCell;
