...
/**
 * An implementation of BFFModel which is built to work with BFFURLRequests.
 *
 * If you use a BFFURLRequestModel as the delegate of your BFFURLRequests, it will automatically
 * manage many of the BFFModel properties based on the state of your requests.
 */
@interface BFFURLRequestModel : BFFModel <BFFURLRequestDelegate> {
  BFFURLRequest* _loadingRequest;
