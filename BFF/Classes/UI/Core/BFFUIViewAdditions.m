...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
@implementation UITouch (BFFCategory)
...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
@implementation UIEvent (BFFCategory)
...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
@implementation UIView (BFFCategory)
...
- (CGFloat)orientationWidth {
  return UIInterfaceOrientationIsLandscape(BFFInterfaceOrientation())
...
- (CGRect)frameWithKeyboardSubtracted:(CGFloat)plusHeight {
  CGRect frame = self.frame;
  if (BFFIsKeyboardVisible()) {
    CGRect screenFrame = BFFScreenBounds();
    CGFloat keyboardTop = (screenFrame.size.height - (BFFKeyboardHeight() + plusHeight));
