...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
@implementation BFFSectionedDataSource
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (void)dealloc {
  BFF_RELEASE_SAFELY(_items);
  BFF_RELEASE_SAFELY(_sections);
  ...
  if (_sections.count) {
    for (NSInteger i = 0; i < _items.count; ++i) {
      ...
      for (NSInteger j = 0; j < items.count; ++j) {
        BFFTableItem* item = [items objectAtIndex:j];
    ...
    for (NSInteger i = 0; i < _items.count; ++i) {
      BFFTableItem* item = [_items objectAtIndex:i];
      if (item.userInfo == userInfo) {
