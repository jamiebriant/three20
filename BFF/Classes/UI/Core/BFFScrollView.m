...
- (void)dealloc {
  ...
  BFF_RELEASE_SAFELY(_animationStartTime);
  BFF_RELEASE_SAFELY(_pages);
  BFF_RELEASE_SAFELY(_pageQueue);
...
- (void)layoutPage {
  ...
  if (nil != page) {
    CGAffineTransform rotation = BFFRotateTransformForOrientation(_orientation);
...
- (void)startAnimationTo:(UIEdgeInsets)edges duration:(NSTimeInterval)duration {
  if (!_animationTimer) {
    ...
    BFF_INVALIDATE_TIMER(_tapTimer);
...
- (void)touchesMoved:(NSSet*)touches withEvent:(UIEvent *)event {
  ...
  BFF_INVALIDATE_TIMER(_holdingTimer);
...
//  UIInterfaceOrientation orientation = BFFDeviceOrientation();
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (void)setDataSource:(id<BFFScrollViewDataSource>)dataSource {
