...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
@implementation BFFTextBarController
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (void)loadView {
  CGSize screenSize = BFFScreenBounds().size;

  self.view = [[[UIView alloc] init] autorelease];
  _textBar = [[BFFView alloc] init];
  _textBar.style = BFFSTYLE(textBar);
  ...
  self.view.frame = CGRectMake(0, screenSize.height - (BFFKeyboardHeight() + _textEditor.height),
                              screenSize.width, _textEditor.height+kMargin*2);
...
- (void)viewDidUnload {
  [super viewDidUnload];
  BFF_RELEASE_SAFELY(_textBar);
  BFF_RELEASE_SAFELY(_textEditor);
  BFF_RELEASE_SAFELY(_postButton);
  BFF_RELEASE_SAFELY(_previousRightBarButtonItem);
}
...
- (void)showInView:(UIView*)view animated:(BOOL)animated {
  self.view.transform = BFFRotateTransformForOrientation(BFFInterfaceOrientation());
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (void)textEditorDidBeginEditing:(BFFTextEditor*)textEditor {
  [self retain];
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (void)textEditorDidEndEditing:(BFFTextEditor*)textEditor {
  UIViewController* controller = self.view.viewController;
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (BFFTextEditor*)textEditor {
  if (!_textEditor) {
    _textEditor = [[BFFTextEditor alloc] init];
    _textEditor.delegate = self;
    _textEditor.style = BFFSTYLE(textBarTextField);
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (BFFButton*)postButton {
  if (!_postButton) {
    _postButton = [[BFFButton buttonWithStyle:@"textBarPostButton:"
