...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
@implementation BFFTableImageItem
...
- (void)dealloc {
  ...
  BFF_RELEASE_SAFELY(_imageStyle);
...
+ (id)itemWithText:(NSString*)text imageURL:(NSString*)imageURL {
  BFFTableImageItem* item = [[[self alloc] init] autorelease];
  item.text = text;
...
///////////////////////////////////////////////////////////////////////////////////////////////////
+ (id)itemWithText:(NSString*)text imageURL:(NSString*)imageURL defaultImage:(UIImage*)defaultImage
        imageStyle:(BFFStyle*)imageStyle URL:(NSString*)URL {
  BFFTableImageItem* item = [[[self alloc] init] autorelease];
  item.text = text;
  item.imageURL = imageURL;
  item.defaultImage = defaultImage;
