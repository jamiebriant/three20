...
@protocol BFFWebControllerDelegate;

@interface BFFWebController : BFFModelViewController <UIWebViewDelegate, UIActionSheetDelegate> {
@protected
  UIWebView*        _webView;
  ...
  id<BFFWebControllerDelegate> _delegate;
}
 ...
 */
@property (nonatomic, assign)   id<BFFWebControllerDelegate> delegate;
...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
@protocol BFFWebControllerDelegate <NSObject>
