...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
@implementation BFFBevelBorderStyle
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (void)dealloc {
  BFF_RELEASE_SAFELY(_highlight);
  BFF_RELEASE_SAFELY(_shadow);
...
///////////////////////////////////////////////////////////////////////////////////////////////////
+ (BFFBevelBorderStyle*)styleWithColor:(UIColor*)color width:(CGFloat)width next:(BFFStyle*)next {
...
///////////////////////////////////////////////////////////////////////////////////////////////////
+ (BFFBevelBorderStyle*)styleWithHighlight:(UIColor*)highlight shadow:(UIColor*)shadowColor
                                    width:(CGFloat)width lightSource:(NSInteger)lightSource next:(BFFStyle*)next {
  BFFBevelBorderStyle* style = [[[BFFBevelBorderStyle alloc] initWithNext:next] autorelease];
