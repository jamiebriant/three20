...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
@implementation BFFTableMoreButtonCell
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (void)dealloc {
  BFF_RELEASE_SAFELY(_activityIndicatorView);
...
+ (CGFloat)tableView:(UITableView*)tableView rowHeightForObject:(id)object {
  ...
  CGFloat minHeight = BFF_ROW_HEIGHT * 1.5;
...
- (void)setObject:(id)object {
  if (_item != object) {
    ...
    BFFTableMoreButton* item = object;
    self.animating = item.isLoading;

    self.textLabel.textColor = BFFSTYLEVAR(moreLinkTextColor);
