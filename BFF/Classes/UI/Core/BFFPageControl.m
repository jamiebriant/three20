...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (void)dealloc {
  BFF_RELEASE_SAFELY(_dotStyle);
  BFF_RELEASE_SAFELY(_normalDotStyle);
  BFF_RELEASE_SAFELY(_currentDotStyle);
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (BFFStyle*)normalDotStyle {
  if (!_normalDotStyle) {
    _normalDotStyle = [[[BFFStyleSheet globalStyleSheet] styleWithSelector:_dotStyle
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (BFFStyle*)currentDotStyle {
  if (!_currentDotStyle) {
    _currentDotStyle = [[[BFFStyleSheet globalStyleSheet] styleWithSelector:_dotStyle
...
- (void)drawRect:(CGRect)rect {
  if (_numberOfPages > 1 || _hidesForSinglePage) {
    ...
    BFFBoxStyle* boxStyle = [self.normalDotStyle firstStyleOfClass:[BFFBoxStyle class]];
