...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
@implementation BFFLauncherButton
...
- (void)dealloc {
  ...
  BFF_RELEASE_SAFELY(_closeButton);
...
- (void)updateBadge {
  if (!_badge && _item.badgeNumber) {
    ...
    _badge.style = BFFSTYLE(largeBadge);
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (BFFButton*)closeButton {
  if (!_closeButton && _item.canDelete) {
    _closeButton = [[BFFButton buttonWithStyle:@"launcherCloseButton:"] retain];
