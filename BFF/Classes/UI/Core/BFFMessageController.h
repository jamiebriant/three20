...
@protocol BFFMessageControllerDelegate;
@class BFFPickerTextField;
@class BFFActivityLabel;
@class BFFTextEditor;
 ...
 */
@interface BFFMessageController : BFFViewController <UITextFieldDelegate, BFFTextEditorDelegate> {
@protected
  NSArray*          _fields;
  NSMutableArray*   _fieldViews;
  UIScrollView*     _scrollView;
  BFFTextEditor*     _textEditor;
  BFFActivityLabel*  _activityView;
  NSArray*          _initialRecipients;

  BOOL _showsRecipientPicker;
  BOOL _isModified;

  id<BFFTableViewDataSource>       _dataSource;
  id<BFFMessageControllerDelegate> _delegate;
}

/**
 * The delegate that will receive messages from the BFFMessageControllerDelegate
 * protocol.
 */
@property (nonatomic, assign) id<BFFMessageControllerDelegate> delegate;

/**
 * The datasource used to autocomplete BFFMessageRecipientFields. This class is
 * also responsible for determining how cells representing recipients are
 * labeled.
 */
@property (nonatomic, retain) id<BFFTableViewDataSource> dataSource;

/**
 * An array of BFFMessageField instances representing the editable fields. These
 ...
 * BFFMessageSubjectField. If no BFFMessageSubjectField is found in the fields
 ...
 * BFFMessageRecipientField instances.
 */
 ...
 * be pre-filled in the BFFMessageRecipientField's view.
 *
 * If a non-empty recipients array is provided, BFFMessageController expects
 * the first field to be an instance of BFFMessageRecipientField. You may pass
