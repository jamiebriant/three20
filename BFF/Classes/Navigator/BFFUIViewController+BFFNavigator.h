...
@interface UIViewController (BFFNavigator)

/**
 * The default initializer sent to view controllers opened through BFFNavigator.
 */
...
/**
 * The URL that was used to load this controller through BFFNavigator.
 *
 * Do not ever change the value of this property.  BFFNavigator will assign this
 ...
 *
 * While restoring controllers, BFFURLMap will assign this the dictionary created by persistView.
