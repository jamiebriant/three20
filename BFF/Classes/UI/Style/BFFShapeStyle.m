...
///////////////////////////////////////////////////////////////////////////////////////////////////
+ (BFFShapeStyle*)styleWithShape:(BFFShape*)shape next:(BFFStyle*)next {
  BFFShapeStyle* style = [[[self alloc] initWithNext:next] autorelease];
  style.shape = shape;
  return style;
}
...
- (void)draw:(BFFStyleContext*)context {
  ...
  context.contentFrame = BFFRectInset(context.contentFrame, shapeInsets);
