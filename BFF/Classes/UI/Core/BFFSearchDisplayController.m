...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
@implementation BFFSearchDisplayController
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (void)dealloc {
  BFF_INVALIDATE_TIMER(_pauseTimer);
  BFF_RELEASE_SAFELY(_searchResultsDelegate2);
  BFF_RELEASE_SAFELY(_searchResultsViewController);
...
//    [UIView beginAnimations:nil context:nil];
//    self.searchBar.superview.top -= self.searchBar.screenY - BFFStatusHeight();
//    [UIView commitAnimations];
//  }
}
...
//  if (!self.searchContentsController.navigationController) {
//    [UIView beginAnimations:nil context:nil];
//    self.searchBar.superview.top += self.searchBar.top - BFFStatusHeight();
//    [UIView commitAnimations];
//  }
}
