...
@class BFFActionSheetController;

/**
 * Inherits the UIActionSheetDelegate protocol and adds BFFNavigator support.
 */
@protocol BFFActionSheetControllerDelegate <UIActionSheetDelegate>
@optional
 ...
 *
 * @return YES to open the given URL with BFFOpenURL.
 */
- (BOOL)actionSheetController: (BFFActionSheetController*)controller
