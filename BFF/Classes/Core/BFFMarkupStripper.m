...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
@implementation BFFMarkupStripper


///////////////////////////////////////////////////////////////////////////////////////////////////
- (void)dealloc {
  BFF_RELEASE_SAFELY(_strings);
...
- (NSData*)             parser: (NSXMLParser*)parser
  ...
  return [[[BFFEntityTables sharedInstance] iso88591] objectForKey:entityName];
}
