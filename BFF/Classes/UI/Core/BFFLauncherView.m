...
// UI (private)
#import "BFFLauncherScrollView.h"
...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
@implementation BFFLauncherView
...
- (id)initWithFrame:(CGRect)frame {
  if (self = [super initWithFrame:frame]) {
    _scrollView = [[BFFLauncherScrollView alloc] initWithFrame:
    ...
    _pager = [[BFFPageControl alloc] init];
...
- (void)dealloc {
  for (NSArray* page in _pages) {
    for (BFFLauncherItem* item in page) {
      item.launcher = nil;
    }
  }
  ...
  BFF_INVALIDATE_TIMER(_editHoldTimer);
  BFF_INVALIDATE_TIMER(_springLoadTimer);
  BFF_RELEASE_SAFELY(_pages);
  BFF_RELEASE_SAFELY(_buttons);
  BFF_RELEASE_SAFELY(_scrollView);
  BFF_RELEASE_SAFELY(_pager);
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (BFFLauncherButton*)buttonForItem:(BFFLauncherItem*)item {
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (NSMutableArray*)pageWithItem:(BFFLauncherItem*)item {
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (NSMutableArray*)pageWithButton:(BFFLauncherButton*)button {
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (void)updateItemBadge:(BFFLauncherItem*)item {
  BFFLauncherButton* button = [self buttonForItem:item];
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (BFFLauncherButton*)addButtonWithItem:(BFFLauncherItem*)item {
  BFFLauncherButton* button = [[[BFFLauncherButton alloc] initWithItem:item] autorelease];
...
- (void)layoutButtons {
  ...
  for (NSMutableArray* buttonPage in _buttons) {
    CGFloat y = kMargin;
    for (BFFLauncherButton* button in buttonPage) {
...
- (void)recreateButtons {
  ...
  for (NSArray* page in _pages) {
    ...
    for (BFFLauncherItem* item in page) {
      BFFLauncherButton* button = [self addButtonWithItem:item];
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (void)startDraggingButton:(BFFLauncherButton*)button withEvent:(UIEvent*)event {
  BFF_INVALIDATE_TIMER(_springLoadTimer);
...
- (void)removeButtonAnimationDidStop:(NSString*)animationID finished:(NSNumber*)finished
  ...
  BFFLauncherButton* button = context;
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (void)buttonTouchedUpInside:(BFFLauncherButton*)button {
  if (_editing) {
    ...
    [self performSelector:@selector(deselectButton:) withObject:button
          afterDelay:BFF_TRANSITION_DURATION];
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (void)buttonTouchedUpOutside:(BFFLauncherButton*)button {
  if (_editing) {
    if (button == _dragButton) {
      [self startDraggingButton:nil withEvent:nil];
    }
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (void)buttonTouchedDown:(BFFLauncherButton*)button withEvent:(UIEvent*)event {
  if (_editing) {
    if (!_dragButton) {
    ...
    _editHoldTimer = [NSTimer scheduledTimerWithTimeInterval:kEditHoldTimeInterval
                              ...
                              userInfo:[BFFUserInfo topic:nil strongRef:event weakRef:button]
                              repeats:NO];
  }
}
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (void)closeButtonTouchedUpInside:(BFFButton*)closeButton {
...
- (void)editHoldTimer:(NSTimer*)timer {
  ...
  BFFUserInfo* info = timer.userInfo;
  BFFLauncherButton* button = info.weakRef;
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (void)deselectButton:(BFFLauncherButton*)button {
...
- (void)updateTouch {
  ...
  BFFDCONDITIONLOG(BFFDFLAG_LAUNCHERVIEW, @"%f < %f", springLoadDistance, _dragButton.center.x);
...
- (void)setPages:(NSArray*)pages {
  ...
  for (NSArray* page in pages) {
    ...
    for (BFFLauncherItem* item in pageCopy) {
      item.launcher = self;
    }
    [pageCopy release];
  }
