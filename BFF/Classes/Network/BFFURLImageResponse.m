...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
@implementation BFFURLImageResponse
...
- (NSError*)request:(BFFURLRequest*)request processResponse:(NSHTTPURLResponse*)response
  ...
  // probably a mistake.
  BFFDASSERT([data isKindOfClass:[UIImage class]]
            || [data isKindOfClass:[NSData class]]);
  BFFDASSERT(nil == _image);
  ...
  if ([data isKindOfClass:[UIImage class]]) {
    ...
    UIImage* image = [[BFFURLCache sharedCache] imageForURL:request.urlPath fromDisk:NO];
...
//          [[BFFURLCache sharedCache] storeData:data forURL:request.URL];
//        }
        [[BFFURLCache sharedCache] storeImage:image forURL:request.urlPath];
      }

      _image = [image retain];

    } else {
      return [NSError errorWithDomain:BFF_ERROR_DOMAIN code:BFF_EC_INVALID_IMAGE
                      userInfo:nil];
    }
  }
