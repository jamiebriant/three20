...
// UI
#import "BFFPickerTextFieldDelegate.h"
...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
@implementation BFFPickerTextField
...
- (CGFloat)layoutCells {
  ...
  if (self.width) {
    for (BFFPickerViewCell* cell in _cellViews) {
      [cell sizeToFit];
...
- (void)touchesBegan:(NSSet*)touches withEvent:(UIEvent*)event {
  ...
  if (_dataSource) {
    ...
    if (touch.view == self) {
      ...
      if ([touch.view isKindOfClass:[BFFPickerViewCell class]]) {
        self.selectedCell = (BFFPickerViewCell*)touch.view;
...
///////////////////////////////////////////////////////////////////////////////////////////////////
#pragma mark -
#pragma mark BFFSearchTextField
...
- (CGRect)rectForSearchResults:(BOOL)withKeyboard {
  ...
  CGFloat tableHeight = BFFScreenBounds().size.height - (y + visibleHeight + keyboardHeight);
...
- (NSArray*)cells {
  ...
  for (BFFPickerViewCell* cellView in _cellViews) {
...
- (void)addCellWithObject:(id)object {
  BFFPickerViewCell* cell = [[[BFFPickerViewCell alloc] init] autorelease];
...
- (void)removeCellWithObject:(id)object {
  for (int i = 0; i < _cellViews.count; ++i) {
    BFFPickerViewCell* cell = [_cellViews objectAtIndex:i];
...
- (void)removeAllCells {
  while (_cellViews.count) {
    BFFPickerViewCell* cell = [_cellViews objectAtIndex:0];
    [cell removeFromSuperview];
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (void)setSelectedCell:(BFFPickerViewCell*)cell {
  if (_selectedCell) {
