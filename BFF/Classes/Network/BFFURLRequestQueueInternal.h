...
@class BFFRequestLoader;

/**
 * The internal interface for the BFFRequestLoaders to interact with the BFFURLRequestQueue.
 */
@interface BFFURLRequestQueue (BFFRequestLoader)
