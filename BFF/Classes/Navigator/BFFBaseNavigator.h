...
#import "BFFNavigatorPersistenceMode.h"

@protocol BFFNavigatorDelegate;
@class BFFURLAction;
@class BFFURLMap;
@class BFFURLPattern;
 ...
 */
@interface BFFBaseNavigator : NSObject {
  BFFURLMap*                   _URLMap;
  ...
  BFFNavigatorPersistenceMode  _persistenceMode;
  ...
  id<BFFNavigatorDelegate>     _delegate;
}
 ...
 * @see BFFURLMap
 */
@property (nonatomic, readonly) BFFURLMap* URLMap;
 ...
 *
 * @default BFFNavigatorPersistenceModeNone
 */
@property (nonatomic) BFFNavigatorPersistenceMode persistenceMode;
...
@property (nonatomic, assign) id<BFFNavigatorDelegate> delegate;
 ...
 *
 * This method replaces all other openURL methods by using the chainable BFFURLAction object.
 *
 ...
 *
 * Example BFFURLAction initialization:
 * [[BFFURLAction actionWithURLPath:@"tt://some/path"]
 *                   applyAnimated:YES]
 *
 * Each apply* method on the BFFURLAction object returns self, allowing you to chain methods
 ...
 */
- (UIViewController*)openURLAction:(BFFURLAction*)URLAction;
