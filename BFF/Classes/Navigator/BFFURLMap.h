...
@class BFFURLNavigatorPattern;
@class BFFURLGeneratorPattern;

@interface BFFURLMap : NSObject {
  ...
  BFFURLNavigatorPattern*  _defaultObjectPattern;
  BFFURLNavigatorPattern*  _hashPattern;
