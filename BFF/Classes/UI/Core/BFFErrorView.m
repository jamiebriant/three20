...
- (id)initWithFrame:(CGRect)frame {
  if (self = [super initWithFrame:frame]) {
    ...
    _titleView.textColor = BFFSTYLEVAR(tableErrorTextColor);
    _titleView.font = BFFSTYLEVAR(errorTitleFont);
    ...
    _subtitleView.textColor = BFFSTYLEVAR(tableErrorTextColor);
    _subtitleView.font = BFFSTYLEVAR(errorSubtitleFont);
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (void)dealloc {
  BFF_RELEASE_SAFELY(_imageView);
  BFF_RELEASE_SAFELY(_titleView);
  BFF_RELEASE_SAFELY(_subtitleView);
