...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
@implementation UIViewController (BFFCategory)
 ...
 *
 * See BFFGarbageCollection additions at the bottom of this file for more implementation details.
 *
 * TODO (jverkoey May 19, 2010): Consider phasing out the use of an addition entirely. Instead,
 * place all functionality within the BFFBaseViewController class.
 */
...
+ (void)doCommonGarbageCollection {
  ...
  if ([controllers count] == 0) {
    ...
    BFF_RELEASE_SAFELY(gsCommonControllers);
  }
}
...
+ (void)ttAddCommonController:(UIViewController*)controller {
  ...
  // BFFBaseViewController calls unsetCommonProperties in its dealloc, so we don't need
  // to set up the garbage collector in that case.
  if (![controller isKindOfClass:[BFFBaseViewController class]]) {
...
- (void)setSuperController:(UIViewController*)viewController {
  ...
  if (nil != viewController) {
    if (nil == gSuperControllers) {
      gSuperControllers = BFFCreateNonRetainingDictionary();
    }
...
- (void)setPopupViewController:(UIViewController*)viewController {
  ...
  if (viewController) {
    if (!gPopupViewControllers) {
      gPopupViewControllers = BFFCreateNonRetainingDictionary();
    }
...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
@implementation UIViewController (BFFGarbageCollection)
  ...
  if ([controllers count] > 0) {
    ...
    for (UIViewController* controller in fullControllerList) {
      ...
      if (retainCount == 1) {
        ...
        BFFDASSERT([controller respondsToSelector:selector]);
    ...
    BFF_RELEASE_SAFELY(fullControllerList);
  }
}
