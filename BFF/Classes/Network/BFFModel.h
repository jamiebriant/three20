...
/**
 * BFFModel describes the state of an object that can be loaded from a remote source.
 *
 * By implementing this protocol, you can communicate to the user the state of network
 * activity in an object.
 */
@protocol BFFModel <NSObject>

/**
 * An array of objects that conform to the BFFModelDelegate protocol.
 */
...
/**
 * A default implementation of BFFModel does nothing other than appear to be loaded.
 */
@interface BFFModel : NSObject <BFFModel> {
