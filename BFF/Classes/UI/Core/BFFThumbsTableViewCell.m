...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
@implementation BFFThumbsTableViewCell
...
- (void)dealloc {
  ...
  BFF_RELEASE_SAFELY(_thumbViews);
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (void)assignPhotoAtIndex:(int)photoIndex toView:(BFFThumbView*)thumbView {
  id<BFFPhoto> photo = [_photo.photoSource photoAtIndex:photoIndex];
  if (photo) {
    thumbView.thumbURL = [photo URLForVersion:BFFPhotoVersionThumbnail];
    thumbView.hidden = NO;
  } else {
...
- (void)layoutThumbViews {
  ...
  for (BFFThumbView* thumbView in _thumbViews) {
...
- (void)setColumnCount:(NSInteger)columnCount {
  if (_columnCount != columnCount) {
    ...
    for (NSInteger i = _thumbViews.count; i < _columnCount; ++i) {
      BFFThumbView* thumbView = [[[BFFThumbView alloc] init] autorelease];
