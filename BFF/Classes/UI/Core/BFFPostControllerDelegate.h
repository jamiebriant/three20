...
@protocol BFFPostControllerDelegate <NSObject>
@optional
 ...
 */
- (BOOL)postController:(BFFPostController*)postController willPostText:(NSString*)text;
 ...
 */
- (CGRect)postController:(BFFPostController*)postController willAnimateTowards:(CGRect)rect;

/**
 * The text has been posted.
 */
- (void)postController: (BFFPostController*)postController
 ...
 */
- (void)postControllerDidCancel:(BFFPostController*)postController;
