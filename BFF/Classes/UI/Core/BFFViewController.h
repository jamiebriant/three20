...
@class BFFSearchDisplayController;

/**
 * A view controller with some useful additions.
 */
@interface BFFViewController : BFFNavigatorViewController {
@protected
  BFFSearchDisplayController* _searchController;
}
 ...
 */
@property (nonatomic, retain) BFFTableViewController* searchViewController;
