...
#import "BFFNavigationMode.h"

@interface BFFURLNavigatorPattern : BFFURLPattern {
  Class             _targetClass;
  id                _targetObject;
  BFFNavigationMode  _navigationMode;
  NSString*         _parentURL;
...
@property (nonatomic, readonly) BFFNavigationMode  navigationMode;
...
- (id)initWithTarget:(id)target mode:(BFFNavigationMode)navigationMode;
