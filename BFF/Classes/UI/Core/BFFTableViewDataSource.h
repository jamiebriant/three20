...
@protocol BFFTableViewDataSource <UITableViewDataSource, BFFModel, UISearchDisplayDelegate>

/**
 * Optional method to return a model object to delegate the BFFModel protocol to.
 */
@property (nonatomic, retain) id<BFFModel> model;
...
@interface BFFTableViewDataSource : NSObject <BFFTableViewDataSource> {
  id<BFFModel> _model;
}
 ...
 */
@interface BFFTableViewInterstitialDataSource : BFFTableViewDataSource <BFFModel>
@end
