...
- (id)initWithFrame:(CGRect)frame {
  if (self = [super initWithFrame:frame]) {
    _boxView = [[BFFView alloc] init];
    _boxView.backgroundColor = [UIColor clearColor];
    [self addSubview:_boxView];

    _searchField = [[BFFSearchTextField alloc] init];
    _searchField.placeholder = BFFLocalizedString(@"Search", @"");
    ...
    self.tintColor = BFFSTYLEVAR(searchBarTintColor);
    self.style = BFFSTYLE(searchBar);
    self.textFieldStyle = BFFSTYLE(searchTextField);
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (void)dealloc {
  BFF_RELEASE_SAFELY(_searchField);
  BFF_RELEASE_SAFELY(_boxView);
  BFF_RELEASE_SAFELY(_textFieldStyle);
  BFF_RELEASE_SAFELY(_tintColor);
  BFF_RELEASE_SAFELY(_cancelButton);
...
- (CGSize)sizeThatFits:(CGSize)size {
  ...
  if (height < BFF_ROW_HEIGHT) {
    height = BFF_ROW_HEIGHT;
  }
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (id<BFFTableViewDataSource>)dataSource {
...
- (void)setShowsCancelButton:(BOOL)showsCancelButton {
  if (showsCancelButton != _showsCancelButton) {
    ...
    if (_showsCancelButton) {
      _cancelButton = [[BFFButton buttonWithStyle:@"blackToolbarButton:"
                                 title:BFFLocalizedString(@"Cancel", @"")] retain];
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (void)setTextFieldStyle:(BFFStyle*)textFieldStyle {
