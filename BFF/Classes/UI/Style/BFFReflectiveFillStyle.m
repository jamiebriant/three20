...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
@implementation BFFReflectiveFillStyle
...
///////////////////////////////////////////////////////////////////////////////////////////////////
+ (BFFReflectiveFillStyle*)styleWithColor:(UIColor*)color next:(BFFStyle*)next {
  BFFReflectiveFillStyle* style = [[[self alloc] initWithNext:next] autorelease];
  style.color = color;
...
///////////////////////////////////////////////////////////////////////////////////////////////////
+ (BFFReflectiveFillStyle*)styleWithColor:(UIColor*)color
                     withBottomHighlight:(BOOL)withBottomHighlight next:(BFFStyle*)next {
  BFFReflectiveFillStyle* style = [[[self alloc] initWithNext:next] autorelease];
  style.color = color;
