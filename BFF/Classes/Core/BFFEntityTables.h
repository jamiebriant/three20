 ...
 */
@interface BFFEntityTables : NSObject {
...
@interface BFFEntityTables (BFFSingleton)

// Access the singleton instance: [[BFFEntityTables sharedInstance] <methods>]
+ (BFFEntityTables*)sharedInstance;
