 ...
 */
BOOL BFFIsBundleURL(NSString* URL);

/**
 * @return YES if the URL begins with "documents://"
 */
BOOL BFFIsDocumentsURL(NSString* URL);

/**
 * @return The main bundle path concatenated with the given relative path.
 */
NSString* BFFPathForBundleResource(NSString* relativePath);

/**
 * @return The documents path concatenated with the given relative path.
 */
NSString* BFFPathForDocumentsResource(NSString* relativePath);
