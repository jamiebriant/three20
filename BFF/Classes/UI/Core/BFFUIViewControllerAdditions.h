...
@interface UIViewController (BFFCategory)
 ...
 * custom UIViewController subclasses the chance to tell BFFNavigator how to follow the hierarchy
 * of view controllers.
 */
 ...
 * subclasses the chance to tell BFFNavigator how to follow the hierarchy of view controllers.
 */
 ...
 *
 * BFFURLMap uses this to display newly created controllers.  The default does nothing --
 ...
 *
 * BFFURLMap uses this to display controllers that exist already, but may not be visible.
 ...
 *
 * This will be called when BFFNavigator is persisting the navigation history so that it
 ...
 *
 * This will be called when BFFNavigator is restoring the navigation history.  This may
...
/**
 * Finishes initializing the controller after a BFFNavigator-coordinated delay.
 *
 * If the controller was created in between calls to BFFNavigator beginDelay and endDelay, then
