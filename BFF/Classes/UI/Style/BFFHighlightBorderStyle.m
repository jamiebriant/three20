...
#import "BFFHighlightBorderStyle.h"
...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
@implementation BFFHighlightBorderStyle
...
- (void)dealloc {
  ...
  BFF_RELEASE_SAFELY(_highlightColor);
...
///////////////////////////////////////////////////////////////////////////////////////////////////
+ (BFFHighlightBorderStyle*)styleWithColor:(UIColor*)color highlightColor:(UIColor*)highlightColor
                                    width:(CGFloat)width next:(BFFStyle*)next {
  BFFHighlightBorderStyle* style = [[[self alloc] initWithNext:next] autorelease];
  style.color = color;
