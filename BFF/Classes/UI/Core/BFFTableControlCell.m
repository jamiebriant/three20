...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
@implementation BFFTableControlCell
...
+ (BOOL)shouldSizeControlToFit:(UIView*)view {
  ...
  || [view isKindOfClass:[BFFTextEditor class]];
}
...
+ (CGFloat)tableView:(UITableView*)tableView rowHeightForObject:(id)object {
  ...
  if ([object isKindOfClass:[UIView class]]) {
    ...
    BFFTableControlItem* controlItem = object;
  ...
  if (YES || !height) { // JAB: Again, always calculate because it f****** changes.
    ...
    } else if ([view isKindOfClass:[BFFTextEditor class]]) {
      BFFTextEditor* textEditor = (BFFTextEditor*)view;
...
- (void)layoutSubviews {
  ...
  if ([BFFTableControlCell shouldSizeControlToFit:_control]) {
    ...
    if (![BFFTableControlCell shouldRespectControlPadding:_control]) {
    ...
    if ([BFFTableControlCell shouldConsiderControlIntrinsicSize:_control]) {
