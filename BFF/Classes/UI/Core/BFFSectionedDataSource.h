...
@interface BFFSectionedDataSource : BFFTableViewDataSource {
 ...
 *
 * Where item is generally a type of BFFTableItem.
 */
+ (BFFSectionedDataSource*)dataSourceWithObjects:(id)object,...;
 ...
 *
 * Where arrayOfItems is generally an array of items of type BFFTableItem.
 */
+ (BFFSectionedDataSource*)dataSourceWithArrays:(id)object,...;
 ...
 */
+ (BFFSectionedDataSource*)dataSourceWithItems:(NSArray*)items sections:(NSArray*)sections;
