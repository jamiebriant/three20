...
#define BFFSTYLE(_SELECTOR) [[BFFStyleSheet globalStyleSheet] styleWithSelector:@#_SELECTOR]

#define BFFSTYLESTATE(_SELECTOR, _STATE) [[BFFStyleSheet globalStyleSheet] \
                                           styleWithSelector:@#_SELECTOR forState:_STATE]

#define BFFSTYLESHEET ((id)[BFFStyleSheet globalStyleSheet])

#define BFFSTYLEVAR(_VARNAME) [BFFSTYLESHEET _VARNAME]
