...
@interface BFFTableImageItem : BFFTableTextItem {
  NSString* _imageURL;
  UIImage*  _defaultImage;
  BFFStyle*  _imageStyle;
}

@property (nonatomic, copy)   NSString* imageURL;
@property (nonatomic, retain) UIImage*  defaultImage;
@property (nonatomic, retain) BFFStyle*  imageStyle;
...
+ (id)itemWithText:(NSString*)text imageURL:(NSString*)imageURL
      defaultImage:(UIImage*)defaultImage imageStyle:(BFFStyle*)imageStyle URL:(NSString*)URL;
