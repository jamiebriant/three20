 ...
 * scrolling the table.  BFFTableViewController automatically assigns an instance of this
 ...
 */
@interface BFFTableViewDelegate : NSObject <UITableViewDelegate> {
  BFFTableViewController*  _controller;
  NSMutableDictionary*    _headers;
}

- (id)initWithController:(BFFTableViewController*)controller;

@property (nonatomic, readonly) BFFTableViewController* controller;
