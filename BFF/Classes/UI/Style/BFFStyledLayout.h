...
@class BFFStyledInlineFrame;

@interface BFFStyledLayout : NSObject {
  CGFloat _x;
  CGFloat _width;
  CGFloat _height;
  CGFloat _lineWidth;
  ...
  BFFStyledFrame*        _lineFirstFrame;
  BFFStyledInlineFrame*  _inlineFrame;
  BFFStyledBoxFrame*     _topFrame;
  BFFStyledFrame*        _lastFrame;
