...
@class BFFBaseNavigator;

@protocol BFFNavigatorDelegate <NSObject>
@optional
 ...
 */
- (BOOL)navigator:(BFFBaseNavigator*)navigator shouldOpenURL:(NSURL*)URL;
 ...
 */
- (NSURL*)navigator:(BFFBaseNavigator*)navigator URLToOpen:(NSURL*)URL;
 ...
 */
- (void)navigator:(BFFBaseNavigator*)navigator willOpenURL:(NSURL*)URL
