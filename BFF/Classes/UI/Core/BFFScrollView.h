...
@protocol BFFScrollViewDelegate;
@protocol BFFScrollViewDataSource;

@interface BFFScrollView : UIView {
  ...
  id<BFFScrollViewDelegate>    _delegate;
  id<BFFScrollViewDataSource>  _dataSource;
...
@property (nonatomic, assign) id<BFFScrollViewDelegate>    delegate;
@property (nonatomic, assign) id<BFFScrollViewDataSource>  dataSource;
