 ...
 * BFFMessageController. This object is responsible for delivering the message
 ...
 */
@protocol BFFMessageControllerDelegate <NSObject>
 ...
 * supplied fields. The fields array contains subclasses of BFFMessageField. Its
 * last object is the body of the message, contained within a BFFMessageTextField.
 */
- (void)composeController:(BFFMessageController*)controller didSendFields:(NSArray*)fields;

/**
 * Received when the user has chosen to cancel creating their message. Upon
 * returning, the BFFMessageController will be dismissed. Implementations
 * can use this callback to cleanup any resources.
 */
- (void)composeControllerWillCancel:(BFFMessageController*)controller;
 ...
 */
- (void)composeControllerShowRecipientPicker:(BFFMessageController*)controller;
