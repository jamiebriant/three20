...
/**
 * A response protocol for BFFURLRequest. This protocol is used upon the successful retrieval of
 * data from a BFFURLRequest. The processResponse method is used to process the data, whether it
 * be an image or an XML string.
 *
 * @see BFFURLDataResponse
 * @see BFFURLImageResponse
 */
@protocol BFFURLResponse <NSObject>
@required
 ...
 * @param  data       The data received from the BFFURLRequest.
