...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
@implementation BFFWebController
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (void)dealloc {
  BFF_RELEASE_SAFELY(_loadingURL);
...
- (void)shareAction {
  UIActionSheet* sheet = [[[UIActionSheet alloc] initWithTitle:@"" delegate:self
                                             cancelButtonTitle:BFFLocalizedString(@"Cancel", @"") destructiveButtonTitle:nil
                                             otherButtonTitles:BFFLocalizedString(@"Open in Safari", @""), nil] autorelease];
...
- (void)updateToolbarWithOrientation:(UIInterfaceOrientation)interfaceOrientation {
  _toolbar.height = BFFToolbarHeight();
...
- (void)loadView {
  ...
  _webView = [[UIWebView alloc] initWithFrame:BFFToolbarNavigationFrame()];
  ...
  _backButton = [[UIBarButtonItem alloc] initWithImage:
                 BFFIMAGE(@"bundle://Three20.bundle/images/backIcon.png")
  ...
  _forwardButton = [[UIBarButtonItem alloc] initWithImage:
                    BFFIMAGE(@"bundle://Three20.bundle/images/forwardIcon.png")
  ...
  _toolbar = [[UIToolbar alloc] initWithFrame:
              CGRectMake(0, self.view.height - BFFToolbarHeight(), self.view.width, BFFToolbarHeight())];
...
- (void)viewDidUnload {
  ...
  BFF_RELEASE_SAFELY(_webView);
  BFF_RELEASE_SAFELY(_toolbar);
  BFF_RELEASE_SAFELY(_backButton);
  BFF_RELEASE_SAFELY(_forwardButton);
  BFF_RELEASE_SAFELY(_refreshButton);
  BFF_RELEASE_SAFELY(_stopButton);
  BFF_RELEASE_SAFELY(_activityItem);
}
...
- (BOOL)webView:(UIWebView*)webView shouldStartLoadWithRequest:(NSURLRequest*)request
 navigationType:(UIWebViewNavigationType)navigationType {
  if ([[BFFNavigator navigator].URLMap isAppURL:request.URL]) {
    [_loadingURL release];
...
- (void)webViewDidStartLoad:(UIWebView*)webView {
  self.title = BFFLocalizedString(@"Loading...", @"");
