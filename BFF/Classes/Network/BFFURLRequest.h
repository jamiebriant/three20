...
@protocol BFFURLRequestDelegate;
@protocol BFFURLResponse;
 ...
 * processing using BFFURLResponse objects.
 */
@interface BFFURLRequest : NSObject {
  NSString*             _urlPath;
 ...
 *
 * @see BFFURLDataResponse
 * @see BFFURLImageResponse
 * @see BFFURLXMLResponse
 */
@property (nonatomic, retain) id<BFFURLResponse> response;
...
/**
 * @default BFFURLRequestCachePolicyDefault
 */
@property (nonatomic) BFFURLRequestCachePolicy cachePolicy;

/**
 * The maximum age of cached data that can be used as a response.
 *
 * @default BFF_DEFAULT_CACHE_EXPIRATION_AGE (1 week)
 */
 ...
 * Generally BFFUserInfo objects are used here.
 *
 * @see BFFUserInfo
 */
