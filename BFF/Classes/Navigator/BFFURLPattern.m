...
#import "BFFURLPattern.h"

// UINavigator (Private)
#import "BFFURLWildcard.h"
#import "BFFURLLiteral.h"
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (void)dealloc {
  BFF_RELEASE_SAFELY(_URL);
  BFF_RELEASE_SAFELY(_scheme);
  BFF_RELEASE_SAFELY(_path);
  BFF_RELEASE_SAFELY(_query);
  BFF_RELEASE_SAFELY(_fragment);
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (id<BFFURLPatternText>)parseText:(NSString*)text {
  ...
  if (len >= 2
    ...
    BFFURLWildcard* wildcard = [[[BFFURLWildcard alloc] init] autorelease];
    wildcard.name = name;
    ...
    BFFURLLiteral* literal = [[[BFFURLLiteral alloc] init] autorelease];
    literal.name = text;
    _specificity += 2;
    return literal;
  }
...
- (void)parsePathComponent:(NSString*)value {
  id<BFFURLPatternText> component = [self parseText:value];
