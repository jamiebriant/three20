 ...
 * Additions.
 */
@implementation UITabBarController (BFFCategory)
...
- (UIViewController*)rootControllerForController:(UIViewController*)controller {
  if ([controller canContainControllers]) {
    ...
    BFFNavigationController* navController = [[[BFFNavigationController alloc] init] autorelease];
...
- (void)setTabURLs:(NSArray*)URLs {
  ...
  for (NSString* URL in URLs) {
    UIViewController* controller = [[BFFNavigator navigator] viewControllerForURL:URL];
    if (controller) {
