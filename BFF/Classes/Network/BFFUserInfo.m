...
+ (id)topic:(NSString*)topic strongRef:(id)strongRef weakRef:(id)weakRef {
  return [[[BFFUserInfo alloc] initWithTopic:topic strongRef:strongRef weakRef:weakRef] autorelease];
}


//////////////////////////////////////////////////////////////////////////////////////////////////
+ (id)topic:(NSString*)topic {
  return [[[BFFUserInfo alloc] initWithTopic:topic strongRef:nil weakRef:nil] autorelease];
}


//////////////////////////////////////////////////////////////////////////////////////////////////
+ (id)weakRef:(id)weakRef {
  return [[[BFFUserInfo alloc] initWithTopic:nil strongRef:nil weakRef:weakRef] autorelease];
}
...
//////////////////////////////////////////////////////////////////////////////////////////////////
- (void)dealloc {
  BFF_RELEASE_SAFELY(_topic);
  BFF_RELEASE_SAFELY(_strongRef);
  [super dealloc];
}
